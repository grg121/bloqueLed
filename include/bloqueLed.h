...
Por ejemplo, si en el @c bloqueLed @c b están encendidos los LEDs en posiciones 1 y 3 (0 más a la derecha), @c bloqueLedToString(b); devolverá el string @c "00001010"
